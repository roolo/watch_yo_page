...
RSpec.describe WatchingsController, type: :controller do
  ...
  describe 'GET #index' do
    it 'assigns all watchings as @watchings' do
      watching = Watching.create! valid_attributes.merge(yusers: [current_user])
  ...
  describe 'GET #show' do
    it 'assigns the requested watching as @watching' do
      ...
      get :show, params: required_params.merge(id: watching.to_param)
  ...
  describe 'GET #new' do
    it 'assigns a new watching as @watching' do
      get :new, params: required_params.merge(link: valid_attributes[:url])
  ...
  describe 'GET #edit' do
    it 'assigns the requested watching as @watching' do
      watching = Watching.create! valid_attributes
      get :edit, params: required_params.merge(id: watching.to_param)
      expect(assigns(:watching)).to eq(watching)
    end
  end
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new Watching' do
        ...
        end.to change(Watching, :count).by(1)
      end

      it 'assigns a newly created watching as @watching' do
        post :create, params: required_params.merge(watching: valid_attributes)
      ...
      it 'redirects to the created watching' do
        post :create, params: required_params.merge(watching: valid_attributes)
        expect(response).to redirect_to(watchings_path(username: current_user.username))
      end
    end
  end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested watching' do
        watching = Watching.create! valid_attributes
        put :update,
            params: required_params.merge(id: watching.to_param,
                                          watching: new_attributes),
            session: valid_session
        watching.reload
    ...
    context 'with invalid params' do
      it 'assigns the watching as @watching' do
        watching = Watching.create! valid_attributes
        put :update, params: required_params.merge(id: watching.to_param, watching: invalid_attributes)
        expect(assigns(:watching)).to eq(watching)
      end
  ...
  describe 'DELETE #destroy' do
    it 'destroys the requested watching' do
      watching = Watching.create! valid_attributes
      expect do
        delete :destroy, params: required_params.merge(id: watching.to_param)
      end.to change(Watching, :count).by(-1)
    end
