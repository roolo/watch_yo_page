...
RSpec.describe WatchingsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested watching as @watching" do
      watching = Watching.create! valid_attributes
      get :show, params: {id: watching.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested watching as @watching" do
      watching = Watching.create! valid_attributes
      get :edit, params: {id: watching.to_param}, session: valid_session
      expect(assigns(:watching)).to eq(watching)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Watching" do
        expect {
          post :create, params: {watching: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved watching as @watching" do
        post :create, params: {watching: invalid_attributes}, session: valid_session
        expect(assigns(:watching)).to be_a_new(Watching)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested watching" do
        watching = Watching.create! valid_attributes
        put :update, params: {id: watching.to_param, watching: new_attributes}, session: valid_session
        watching.reload
      ...
      it "assigns the requested watching as @watching" do
        watching = Watching.create! valid_attributes
        put :update, params: {id: watching.to_param, watching: valid_attributes}, session: valid_session
        expect(assigns(:watching)).to eq(watching)
      end
    ...
    context "with invalid params" do
      it "assigns the watching as @watching" do
        watching = Watching.create! valid_attributes
        put :update, params: {id: watching.to_param, watching: invalid_attributes}, session: valid_session
        expect(assigns(:watching)).to eq(watching)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested watching" do
      watching = Watching.create! valid_attributes
      expect {
        delete :destroy, params: {id: watching.to_param}, session: valid_session
      }.to change(Watching, :count).by(-1)
    end
